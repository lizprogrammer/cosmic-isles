...
export default class Island3 extends Phaser.Scene {
  ...
  private setupRoom(roomNum: number) {
    ...
    if (roomNum === 1) {
      ...
      // this.instructionPanel.update(QUEST_DATA[3].name, "Find the Song Seed", "Room 1/3");
      ...
      // this.instructionPanel.update(QUEST_DATA[3].name, "Unlock the Door", "Room 2/3");
      ...
      // this.instructionPanel.update(QUEST_DATA[3].name, "Enter the Sanctuary", "Room 3/3");
    }
